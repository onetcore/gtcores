...
public static class CommandConsole
{
    ...
    private static bool _isLogDateFront;

    /// <summary>
    /// 启动应用程序，在控制台程序中的Main方法中调用。
    /// </summary>
    /// <param name="host">服务器宿主。</param>
    /// <param name="logDateFront">是否在日志前面显示时间。</param>
    public static async Task StartCommandHostAsync(this IHost host, bool logDateFront = true)
    {
        _isLogDateFront = logDateFront;
