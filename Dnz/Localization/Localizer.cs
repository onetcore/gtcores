...
namespace Dnz.Localization
{
    ...
    public class Localizer : ILocalizer
    {
        ...
        {
            return ResourceManager.GetString<TResource>(key);
        }
        ...
        {
            return ResourceManager.GetString<TResource>(key, args);
        }
        ...
        {
            return ResourceManager.GetString(expression, args);
        }
        ...
        {
            return ResourceManager.GetString(type, key);
        }
        ...
        /// <param name="args">格式化参数。</param>
        /// <returns>返回当前本地化字符串。</returns>
        public virtual string GetString(Type type, string key, params object?[] args)
        {
            return ResourceManager.GetString(type, key, args);
        }
